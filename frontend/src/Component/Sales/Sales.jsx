...
function Sales() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      if (!input) {
        console.error("Could not find sales-report-content element");
      ...
      const fileName = `Direct_Sales_Report_${new Date().toISOString().split('T')[0]}.pdf`;
      ...
      <div className="sales-xyz-container">
        ...
        <div className="sales-xyz-report-controls">
          <div className="sales-xyz-report-btn-container">
            <button 
              onClick={generatePDF} 
              className="sales-xyz-report-btn"
